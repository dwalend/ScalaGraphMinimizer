...
class UndirectedGraphTest extends FunSuite {
  ...
  val expectedShortestPaths: Seq[(String, String, Some[FirstSteps[_ <: String, Int]])] = Vector(
    (A,A,Some(FirstSteps(0,Set()))),
    (A,B,Some(FirstSteps(1,Set(B)))),
    (A,C,Some(FirstSteps(2,Set(B)))),
    (A,D,Some(FirstSteps(3,Set(B)))),
    (A,E,Some(FirstSteps(2,Set(B)))),
    (A,F,Some(FirstSteps(3,Set(B)))),
    (A,H,Some(FirstSteps(3,Set(B)))),
    (B,A,Some(FirstSteps(1,Set(A)))),
    (B,B,Some(FirstSteps(0,Set()))),
    (B,C,Some(FirstSteps(1,Set(C)))),
    (B,D,Some(FirstSteps(2,Set(C, E)))),
    (B,E,Some(FirstSteps(1,Set(E)))),
    (B,F,Some(FirstSteps(2,Set(E)))),
    (B,H,Some(FirstSteps(2,Set(C, E)))),
    (C,A,Some(FirstSteps(2,Set(B)))),
    (C,B,Some(FirstSteps(1,Set(B)))),
    (C,C,Some(FirstSteps(0,Set()))),
    (C,D,Some(FirstSteps(1,Set(D)))),
    (C,E,Some(FirstSteps(2,Set(D, B, H)))),
    (C,F,Some(FirstSteps(3,Set(D, B, H)))),
    (C,H,Some(FirstSteps(1,Set(H)))),
    (D,A,Some(FirstSteps(3,Set(E, C)))),
    (D,B,Some(FirstSteps(2,Set(E, C)))),
    (D,C,Some(FirstSteps(1,Set(C)))),
    (D,D,Some(FirstSteps(0,Set()))),
    (D,E,Some(FirstSteps(1,Set(E)))),
    (D,F,Some(FirstSteps(2,Set(E)))),
    (D,H,Some(FirstSteps(2,Set(E, C)))),
    (E,A,Some(FirstSteps(2,Set(B)))),
    (E,B,Some(FirstSteps(1,Set(B)))),
    (E,C,Some(FirstSteps(2,Set(B, H, D)))),
    (E,D,Some(FirstSteps(1,Set(D)))),
    (E,E,Some(FirstSteps(0,Set()))),
    (E,F,Some(FirstSteps(1,Set(F)))),
    (E,H,Some(FirstSteps(1,Set(H)))),
    (F,A,Some(FirstSteps(3,Set(E)))),
    (F,B,Some(FirstSteps(2,Set(E)))),
    (F,C,Some(FirstSteps(3,Set(E)))),
    (F,D,Some(FirstSteps(2,Set(E)))),
    (F,E,Some(FirstSteps(1,Set(E)))),
    (F,F,Some(FirstSteps(0,Set()))),
    (F,H,Some(FirstSteps(2,Set(E)))),
    (G,G,Some(FirstSteps(0,Set()))),
    (H,A,Some(FirstSteps(3,Set(C, E)))),
    (H,B,Some(FirstSteps(2,Set(C, E)))),
    (H,C,Some(FirstSteps(1,Set(C)))),
    (H,D,Some(FirstSteps(2,Set(C, E)))),
    (H,E,Some(FirstSteps(1,Set(E)))),
    (H,F,Some(FirstSteps(2,Set(E)))),
  ...
  test("Dijkstra's algorithm should produce the correct label graph for Somegraph") {
    ...
    assert(allShortestPaths == expectedShortestPaths)
  }
